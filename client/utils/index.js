...
export elementsWithLocations from './elementsWithLocations'
...
export constrainLocationToShape from './constrainLocationToShape'
export latexConfig from './latexConfig'
