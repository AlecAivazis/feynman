...
const PatternModal = ({ info, hideOverlay, toggleInitialState }) => (
    <Overlay
        ...
        addon={<Addon checked={info.patternModalInitalVis} toggleInitialState={toggleInitialState} />}
    >
...
const mapDispatchToProps = dispatch => ({
    ...
    toggleInitialState: () => dispatch(togglePatternModalInitialVis(window.localStorage)),
})
